...
## GetTeamMembers
You can execute the `GetTeamMembers` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetTeamMembers(options?: GetTeamMembersOptions, injector?: Injector): CreateDataConnectQueryResult<GetTeamMembersData, undefined>;
```

### Variables
The `GetTeamMembers` Query has no variables.
### Return Type
Recall that calling the `GetTeamMembers` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetTeamMembers` Query is of type `GetTeamMembersData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetTeamMembers`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetTeamMembers, GetTeamMembersOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectGetTeamMembers();

  // You can also pass in an options function (not object) of type `GetTeamMembersOptions` to the Query injector function.
  options: GetTeamMembersOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetTeamMembers(this.options);
}
```
...
You can execute the `CreateContactMessage` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateContactMessage(options?: CreateContactMessageOptions, injector?: Injector): CreateDataConnectMutationResult<CreateContactMessageData, CreateContactMessageVariables, CreateContactMessageVariables>;
```
...
```
### Return Type
Recall that calling the `CreateContactMessage` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateContactMessage` Mutation is of type `CreateContactMessageData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateContactMessage`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, CreateContactMessageVariables } from '@dataconnect/generated';
import { injectCreateContactMessage, CreateContactMessageOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectCreateContactMessage();

  // You can also pass in a `CreateContactMessageOptions` function (not object) to the Mutation injector function.
  options: CreateContactMessageOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateContactMessage(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(createContactMessageVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ senderName: ..., senderEmail: ..., subject: ..., message: ..., senderPhone: ..., });
    ...
    this.mutation.mutateAsync(createContactMessageVars);

    // You can also pass in a `CreateContactMessageOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(createContactMessageVars, this.options());
  }
}
```

## UpdateCompanyInfo
You can execute the `UpdateCompanyInfo` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectUpdateCompanyInfo(options?: UpdateCompanyInfoOptions, injector?: Injector): CreateDataConnectMutationResult<UpdateCompanyInfoData, UpdateCompanyInfoVariables, UpdateCompanyInfoVariables>;
```
...
```
### Return Type
Recall that calling the `UpdateCompanyInfo` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `UpdateCompanyInfo` Mutation is of type `UpdateCompanyInfoData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `UpdateCompanyInfo`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, UpdateCompanyInfoVariables } from '@dataconnect/generated';
import { injectUpdateCompanyInfo, UpdateCompanyInfoOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectUpdateCompanyInfo();

  // You can also pass in a `UpdateCompanyInfoOptions` function (not object) to the Mutation injector function.
  options: UpdateCompanyInfoOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectUpdateCompanyInfo(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(updateCompanyInfoVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ id: ..., address: ..., email: ..., history: ..., missionStatement: ..., name: ..., phone: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(updateCompanyInfoVars);

    // You can also pass in a `UpdateCompanyInfoOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(updateCompanyInfoVars, this.options());
  }
}
```
